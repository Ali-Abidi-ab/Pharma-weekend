                                ...
                                <tr className="border-b border-gray-300">
                                        <td className="py-6 px-4 border-r border-gray-300">
                                            ...
                                            <div className="mt-4 md:mt-0 md:ml-4">
                                                ...
                                                <p className="text-gray-600 text-sm font-medium text-center md:text-left" ><a className='text-red-700 underline font-bold hover:text-green-700' href={pharmacy.location ? `https://www.google.com/maps?q=${pharmacy.location.latitude},${pharmacy.location.longitude}` : "#"} target='_blank' rel="noopener noreferrer">Location link</a></p>
                                            </div>
                                            </div>
                                        </td>
                                        <td className="py-6 px-4 border-r border-gray-300">
